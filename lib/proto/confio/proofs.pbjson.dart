...
final $typed_data.Uint8List hashOpDescriptor = $convert.base64Decode(
    'CgZIYXNoT3ASCwoHTk9fSEFTSBAAEgoKBlNIQTI1NhABEgoKBlNIQTUxMhACEgoKBktFQ0NBSxADEg0KCVJJUEVNRDE2MBAEEgsKB0JJVENPSU4QBQ==');
...
final $typed_data.Uint8List lengthOpDescriptor = $convert.base64Decode(
    'CghMZW5ndGhPcBINCglOT19QUkVGSVgQABINCglWQVJfUFJPVE8QARILCgdWQVJfUkxQEAISDwoLRklYRUQzMl9CSUcQAxISCg5GSVhFRDMyX0xJVFRMRRAEEg8KC0ZJWEVENjRfQklHEAUSEgoORklYRUQ2NF9MSVRUTEUQBhIUChBSRVFVSVJFXzMyX0JZVEVTEAcSFAoQUkVRVUlSRV82NF9CWVRFUxAI');
...
final $typed_data.Uint8List existenceProofDescriptor = $convert.base64Decode(
    'Cg5FeGlzdGVuY2VQcm9vZhIQCgNrZXkYASABKAxSA2tleRIUCgV2YWx1ZRgCIAEoDFIFdmFsdWUSIQoEbGVhZhgDIAEoCzINLmljczIzLkxlYWZPcFIEbGVhZhIiCgRwYXRoGAQgAygLMg4uaWNzMjMuSW5uZXJPcFIEcGF0aA==');
...
final $typed_data.Uint8List nonExistenceProofDescriptor = $convert.base64Decode(
    'ChFOb25FeGlzdGVuY2VQcm9vZhIQCgNrZXkYASABKAxSA2tleRIpCgRsZWZ0GAIgASgLMhUuaWNzMjMuRXhpc3RlbmNlUHJvb2ZSBGxlZnQSKwoFcmlnaHQYAyABKAsyFS5pY3MyMy5FeGlzdGVuY2VQcm9vZlIFcmlnaHQ=');
...
final $typed_data.Uint8List commitmentProofDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List leafOpDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List innerOpDescriptor = $convert.base64Decode(
    'CgdJbm5lck9wEiEKBGhhc2gYASABKA4yDS5pY3MyMy5IYXNoT3BSBGhhc2gSFgoGcHJlZml4GAIgASgMUgZwcmVmaXgSFgoGc3VmZml4GAMgASgMUgZzdWZmaXg=');
...
final $typed_data.Uint8List proofSpecDescriptor = $convert.base64Decode(
    'CglQcm9vZlNwZWMSKgoJbGVhZl9zcGVjGAEgASgLMg0uaWNzMjMuTGVhZk9wUghsZWFmU3BlYxIvCgppbm5lcl9zcGVjGAIgASgLMhAuaWNzMjMuSW5uZXJTcGVjUglpbm5lclNwZWMSGwoJbWF4X2RlcHRoGAMgASgFUghtYXhEZXB0aBIbCgltaW5fZGVwdGgYBCABKAVSCG1pbkRlcHRo');
...
final $typed_data.Uint8List innerSpecDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List batchProofDescriptor = $convert.base64Decode(
    'CgpCYXRjaFByb29mEisKB2VudHJpZXMYASADKAsyES5pY3MyMy5CYXRjaEVudHJ5UgdlbnRyaWVz');
...
final $typed_data.Uint8List batchEntryDescriptor = $convert.base64Decode(
    'CgpCYXRjaEVudHJ5Ei0KBWV4aXN0GAEgASgLMhUuaWNzMjMuRXhpc3RlbmNlUHJvb2ZIAFIFZXhpc3QSNgoIbm9uZXhpc3QYAiABKAsyGC5pY3MyMy5Ob25FeGlzdGVuY2VQcm9vZkgAUghub25leGlzdEIHCgVwcm9vZg==');
...
final $typed_data.Uint8List compressedBatchProofDescriptor = $convert.base64Decode(
    'ChRDb21wcmVzc2VkQmF0Y2hQcm9vZhI1CgdlbnRyaWVzGAEgAygLMhsuaWNzMjMuQ29tcHJlc3NlZEJhdGNoRW50cnlSB2VudHJpZXMSMwoNbG9va3VwX2lubmVycxgCIAMoCzIOLmljczIzLklubmVyT3BSDGxvb2t1cElubmVycw==');
...
const CompressedBatchEntry$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.ics23.CompressedExistenceProof',
      '9': 0,
      '10': 'exist'
    },
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.ics23.CompressedNonExistenceProof',
      '9': 0,
      '10': 'nonexist'
    },
  ],
...
final $typed_data.Uint8List compressedBatchEntryDescriptor = $convert.base64Decode(
    'ChRDb21wcmVzc2VkQmF0Y2hFbnRyeRI3CgVleGlzdBgBIAEoCzIfLmljczIzLkNvbXByZXNzZWRFeGlzdGVuY2VQcm9vZkgAUgVleGlzdBJACghub25leGlzdBgCIAEoCzIiLmljczIzLkNvbXByZXNzZWROb25FeGlzdGVuY2VQcm9vZkgAUghub25leGlzdEIHCgVwcm9vZg==');
...
final $typed_data.Uint8List compressedExistenceProofDescriptor =
    $convert.base64Decode(
        'ChhDb21wcmVzc2VkRXhpc3RlbmNlUHJvb2YSEAoDa2V5GAEgASgMUgNrZXkSFAoFdmFsdWUYAiABKAxSBXZhbHVlEiEKBGxlYWYYAyABKAsyDS5pY3MyMy5MZWFmT3BSBGxlYWYSEgoEcGF0aBgEIAMoBVIEcGF0aA==');
...
final $typed_data.Uint8List compressedNonExistenceProofDescriptor =
    $convert.base64Decode(
        'ChtDb21wcmVzc2VkTm9uRXhpc3RlbmNlUHJvb2YSEAoDa2V5GAEgASgMUgNrZXkSMwoEbGVmdBgCIAEoCzIfLmljczIzLkNvbXByZXNzZWRFeGlzdGVuY2VQcm9vZlIEbGVmdBI1CgVyaWdodBgDIAEoCzIfLmljczIzLkNvbXByZXNzZWRFeGlzdGVuY2VQcm9vZlIFcmlnaHQ=');
