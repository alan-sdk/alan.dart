...
class BitArray extends $pb.GeneratedMessage {
  ...
  'Will be removed in next major version')
  BitArray copyWith(void Function(BitArray) updates) => super.copyWith((message) => updates(message as BitArray)); // ignore: deprecated_member_use
