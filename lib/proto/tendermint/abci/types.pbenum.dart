...
class CheckTxType extends $pb.ProtobufEnum {
  static const CheckTxType NEW = CheckTxType._(
      0,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'NEW');
  static const CheckTxType RECHECK = CheckTxType._(
      1,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'RECHECK');
...
class EvidenceType extends $pb.ProtobufEnum {
  static const EvidenceType UNKNOWN = EvidenceType._(
      0,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'UNKNOWN');
  static const EvidenceType DUPLICATE_VOTE = EvidenceType._(
      1,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'DUPLICATE_VOTE');
  static const EvidenceType LIGHT_CLIENT_ATTACK = EvidenceType._(
      2,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'LIGHT_CLIENT_ATTACK');
...
class ResponseOfferSnapshot_Result extends $pb.ProtobufEnum {
  static const ResponseOfferSnapshot_Result UNKNOWN =
      ResponseOfferSnapshot_Result._(
          0,
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
              : 'UNKNOWN');
