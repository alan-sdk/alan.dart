...
final $typed_data.Uint8List proofDescriptor = $convert.base64Decode(
    'CgVQcm9vZhIUCgV0b3RhbBgBIAEoA1IFdG90YWwSFAoFaW5kZXgYAiABKANSBWluZGV4EhsKCWxlYWZfaGFzaBgDIAEoDFIIbGVhZkhhc2gSFAoFYXVudHMYBCADKAxSBWF1bnRz');
...
final $typed_data.Uint8List valueOpDescriptor = $convert.base64Decode(
    'CgdWYWx1ZU9wEhAKA2tleRgBIAEoDFIDa2V5Ei4KBXByb29mGAIgASgLMhgudGVuZGVybWludC5jcnlwdG8uUHJvb2ZSBXByb29m');
...
final $typed_data.Uint8List dominoOpDescriptor = $convert.base64Decode(
    'CghEb21pbm9PcBIQCgNrZXkYASABKAlSA2tleRIUCgVpbnB1dBgCIAEoCVIFaW5wdXQSFgoGb3V0cHV0GAMgASgJUgZvdXRwdXQ=');
...
final $typed_data.Uint8List proofOpsDescriptor = $convert.base64Decode(
    'CghQcm9vZk9wcxIyCgNvcHMYASADKAsyGi50ZW5kZXJtaW50LmNyeXB0by5Qcm9vZk9wQgTI3h8AUgNvcHM=');
