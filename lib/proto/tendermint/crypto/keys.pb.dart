...
enum PublicKey_Sum { ed25519, secp256k1, notSet }
...
class PublicKey extends $pb.GeneratedMessage {
  ...
  PublicKey copyWith(void Function(PublicKey) updates) =>
      super.copyWith((message) =>
          updates(message as PublicKey)); // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(1)
  set ed25519($core.List<$core.int> v) {
    $_setBytes(0, v);
  }
  ...
  @$pb.TagNumber(2)
  set secp256k1($core.List<$core.int> v) {
    $_setBytes(1, v);
  }
