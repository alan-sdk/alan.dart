...
final $typed_data.Uint8List netAddressDescriptor = $convert.base64Decode(
    'CgpOZXRBZGRyZXNzEhYKAmlkGAEgASgJQgbi3h8CSURSAmlkEhYKAmlwGAIgASgJQgbi3h8CSVBSAmlwEhIKBHBvcnQYAyABKA1SBHBvcnQ=');
...
final $typed_data.Uint8List protocolVersionDescriptor = $convert.base64Decode(
    'Cg9Qcm90b2NvbFZlcnNpb24SGQoDcDJwGAEgASgEQgfi3h8DUDJQUgNwMnASFAoFYmxvY2sYAiABKARSBWJsb2NrEhAKA2FwcBgDIAEoBFIDYXBw');
...
const DefaultNodeInfo$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.tendermint.p2p.ProtocolVersion',
      '8': const {},
      '10': 'protocolVersion'
    },
    const {
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.tendermint.p2p.DefaultNodeInfoOther',
      '8': const {},
      '10': 'other'
    },
  ],
...
final $typed_data.Uint8List defaultNodeInfoDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List defaultNodeInfoOtherDescriptor = $convert.base64Decode(
    'ChREZWZhdWx0Tm9kZUluZm9PdGhlchIZCgh0eF9pbmRleBgBIAEoCVIHdHhJbmRleBIvCgtycGNfYWRkcmVzcxgCIAEoCUIO4t4fClJQQ0FkZHJlc3NSCnJwY0FkZHJlc3M=');
