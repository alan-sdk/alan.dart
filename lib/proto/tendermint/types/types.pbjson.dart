...
final $typed_data.Uint8List blockIDFlagDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List signedMsgTypeDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List partSetHeaderDescriptor = $convert.base64Decode(
    'Cg1QYXJ0U2V0SGVhZGVyEhQKBXRvdGFsGAEgASgNUgV0b3RhbBISCgRoYXNoGAIgASgMUgRoYXNo');
...
final $typed_data.Uint8List partDescriptor = $convert.base64Decode(
    'CgRQYXJ0EhQKBWluZGV4GAEgASgNUgVpbmRleBIUCgVieXRlcxgCIAEoDFIFYnl0ZXMSNAoFcHJvb2YYAyABKAsyGC50ZW5kZXJtaW50LmNyeXB0by5Qcm9vZkIEyN4fAFIFcHJvb2Y=');
...
final $typed_data.Uint8List blockIDDescriptor = $convert.base64Decode(
    'CgdCbG9ja0lEEhIKBGhhc2gYASABKAxSBGhhc2gSTQoPcGFydF9zZXRfaGVhZGVyGAIgASgLMh8udGVuZGVybWludC50eXBlcy5QYXJ0U2V0SGVhZGVyQgTI3h8AUg1wYXJ0U2V0SGVhZGVy');
...
final $typed_data.Uint8List commitDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List commitSigDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List proposalDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List signedHeaderDescriptor = $convert.base64Decode(
    'CgxTaWduZWRIZWFkZXISMAoGaGVhZGVyGAEgASgLMhgudGVuZGVybWludC50eXBlcy5IZWFkZXJSBmhlYWRlchIwCgZjb21taXQYAiABKAsyGC50ZW5kZXJtaW50LnR5cGVzLkNvbW1pdFIGY29tbWl0');
...
final $typed_data.Uint8List lightBlockDescriptor = $convert.base64Decode(
    'CgpMaWdodEJsb2NrEkMKDXNpZ25lZF9oZWFkZXIYASABKAsyHi50ZW5kZXJtaW50LnR5cGVzLlNpZ25lZEhlYWRlclIMc2lnbmVkSGVhZGVyEkMKDXZhbGlkYXRvcl9zZXQYAiABKAsyHi50ZW5kZXJtaW50LnR5cGVzLlZhbGlkYXRvclNldFIMdmFsaWRhdG9yU2V0');
...
final $typed_data.Uint8List blockMetaDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List txProofDescriptor = $convert.base64Decode(
    'CgdUeFByb29mEhsKCXJvb3RfaGFzaBgBIAEoDFIIcm9vdEhhc2gSEgoEZGF0YRgCIAEoDFIEZGF0YRIuCgVwcm9vZhgDIAEoCzIYLnRlbmRlcm1pbnQuY3J5cHRvLlByb29mUgVwcm9vZg==');
