...
class BlockIDFlag extends $pb.ProtobufEnum {
  static const BlockIDFlag BLOCK_ID_FLAG_UNKNOWN = BlockIDFlag._(
      0,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'BLOCK_ID_FLAG_UNKNOWN');
  static const BlockIDFlag BLOCK_ID_FLAG_ABSENT = BlockIDFlag._(
      1,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'BLOCK_ID_FLAG_ABSENT');
  static const BlockIDFlag BLOCK_ID_FLAG_COMMIT = BlockIDFlag._(
      2,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'BLOCK_ID_FLAG_COMMIT');
  static const BlockIDFlag BLOCK_ID_FLAG_NIL = BlockIDFlag._(
      3,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'BLOCK_ID_FLAG_NIL');
...
class SignedMsgType extends $pb.ProtobufEnum {
  static const SignedMsgType SIGNED_MSG_TYPE_UNKNOWN = SignedMsgType._(
      0,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'SIGNED_MSG_TYPE_UNKNOWN');
  static const SignedMsgType SIGNED_MSG_TYPE_PREVOTE = SignedMsgType._(
      1,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'SIGNED_MSG_TYPE_PREVOTE');
  static const SignedMsgType SIGNED_MSG_TYPE_PRECOMMIT = SignedMsgType._(
      2,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'SIGNED_MSG_TYPE_PRECOMMIT');
  static const SignedMsgType SIGNED_MSG_TYPE_PROPOSAL = SignedMsgType._(
      32,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
