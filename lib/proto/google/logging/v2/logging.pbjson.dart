...
const DeleteLogRequest$json = const {
  '1': 'DeleteLogRequest',
  '2': const [
    const {'1': 'log_name', '3': 1, '4': 1, '5': 9, '8': const {}, '10': 'logName'},
  ],
};
...
const WriteLogEntriesRequest$json = const {
  ...
  '2': const [
    const {'1': 'log_name', '3': 1, '4': 1, '5': 9, '8': const {}, '10': 'logName'},
    const {'1': 'resource', '3': 2, '4': 1, '5': 11, '6': '.google.api.MonitoredResource', '8': const {}, '10': 'resource'},
    const {'1': 'labels', '3': 3, '4': 3, '5': 11, '6': '.google.logging.v2.WriteLogEntriesRequest.LabelsEntry', '8': const {}, '10': 'labels'},
    const {'1': 'entries', '3': 4, '4': 3, '5': 11, '6': '.google.logging.v2.LogEntry', '8': const {}, '10': 'entries'},
    const {'1': 'partial_success', '3': 5, '4': 1, '5': 8, '8': const {}, '10': 'partialSuccess'},
    const {'1': 'dry_run', '3': 6, '4': 1, '5': 8, '8': const {}, '10': 'dryRun'},
  ],
...
const ListLogEntriesRequest$json = const {
  ...
  '2': const [
    const {'1': 'resource_names', '3': 8, '4': 3, '5': 9, '8': const {}, '10': 'resourceNames'},
    const {'1': 'filter', '3': 2, '4': 1, '5': 9, '8': const {}, '10': 'filter'},
    const {'1': 'order_by', '3': 3, '4': 1, '5': 9, '8': const {}, '10': 'orderBy'},
...
const TailLogEntriesRequest$json = const {
  ...
  '2': const [
    const {'1': 'resource_names', '3': 1, '4': 3, '5': 9, '8': const {}, '10': 'resourceNames'},
    const {'1': 'filter', '3': 2, '4': 1, '5': 9, '8': const {}, '10': 'filter'},
    const {'1': 'buffer_window', '3': 3, '4': 1, '5': 11, '6': '.google.protobuf.Duration', '8': const {}, '10': 'bufferWindow'},
  ],
};
...
const TailLogEntriesResponse$json = const {
  ...
  '2': const [
    const {'1': 'entries', '3': 1, '4': 3, '5': 11, '6': '.google.logging.v2.LogEntry', '10': 'entries'},
    const {'1': 'suppression_info', '3': 2, '4': 3, '5': 11, '6': '.google.logging.v2.TailLogEntriesResponse.SuppressionInfo', '10': 'suppressionInfo'},
  ],
...
const TailLogEntriesResponse_SuppressionInfo$json = const {
  '1': 'SuppressionInfo',
  '2': const [
    const {'1': 'reason', '3': 1, '4': 1, '5': 14, '6': '.google.logging.v2.TailLogEntriesResponse.SuppressionInfo.Reason', '10': 'reason'},
    const {'1': 'suppressed_count', '3': 2, '4': 1, '5': 5, '10': 'suppressedCount'},
  ],
