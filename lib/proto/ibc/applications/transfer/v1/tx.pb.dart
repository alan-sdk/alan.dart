...
class MsgTransfer extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$5.Height>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'timeoutHeight', subBuilder: $5.Height.create)
  ...
  MsgTransfer copyWith(void Function(MsgTransfer) updates) =>
      super.copyWith((message) =>
          updates(message as MsgTransfer)); // ignore: deprecated_member_use
...
class MsgTransferResponse extends $pb.GeneratedMessage {
  ...
  MsgTransferResponse copyWith(void Function(MsgTransferResponse) updates) =>
      super.copyWith((message) => updates(
          message as MsgTransferResponse)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
