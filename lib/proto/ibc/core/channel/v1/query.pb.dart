...
class QueryChannelRequest extends $pb.GeneratedMessage {
  ...
  QueryChannelRequest copyWith(void Function(QueryChannelRequest) updates) =>
      super.copyWith((message) => updates(
          message as QueryChannelRequest)); // ignore: deprecated_member_use
...
class QueryChannelResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          const $core.bool.fromEnvironment('protobuf.omit_message_names')
              ...
              : 'ibc.core.channel.v1'),
      createEmptyInstance: create)
    ..aOM<$3.Channel>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'channel',
  ...
  QueryChannelResponse copyWith(void Function(QueryChannelResponse) updates) =>
      super.copyWith((message) => updates(
          message as QueryChannelResponse)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class QueryChannelsRequest extends $pb.GeneratedMessage {
  ...
  QueryChannelsRequest copyWith(void Function(QueryChannelsRequest) updates) =>
      super.copyWith((message) => updates(
          message as QueryChannelsRequest)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class QueryChannelsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          const $core.bool.fromEnvironment('protobuf.omit_message_names')
              ...
              : 'ibc.core.channel.v1'),
      createEmptyInstance: create)
    ..pc<$3.IdentifiedChannel>(
        1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'channels', $pb.PbFieldType.PM,
        subBuilder: $3.IdentifiedChannel.create)
    ...
    ..aOM<$2.Height>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'height',
        subBuilder: $2.Height.create)
    ..hasRequiredFields = false;
  ...
  QueryChannelsResponse copyWith(
      ...
      super.copyWith((message) => updates(
          message as QueryChannelsResponse)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class QueryChannelClientStateResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$2.IdentifiedClientState>(
        1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'identifiedClientState',
...
class QueryChannelConsensusStateRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOS(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'channelId')
    ..a<$fixnum.Int64>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'versionNumber', $pb.PbFieldType.OU6,
        defaultOrMaker: $fixnum.Int64.ZERO)
    ..a<$fixnum.Int64>(
        4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'versionHeight', $pb.PbFieldType.OU6,
        defaultOrMaker: $fixnum.Int64.ZERO)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(3)
  $fixnum.Int64 get versionNumber => $_getI64(2);
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  $fixnum.Int64 get versionHeight => $_getI64(3);
  @$pb.TagNumber(4)
  set versionHeight($fixnum.Int64 v) {
    $_setInt64(3, v);
  }

  @$pb.TagNumber(4)
  $core.bool hasVersionHeight() => $_has(3);
  @$pb.TagNumber(4)
  void clearVersionHeight() => clearField(4);
}
...
class QueryChannelConsensusStateResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      createEmptyInstance: create)
    ..aOM<$5.Any>(
        1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'consensusState',
    ...
    ..aOS(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'clientId')
    ..a<$core.List<$core.int>>(
        3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'proof', $pb.PbFieldType.OY)
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          const $core.bool.fromEnvironment('protobuf.omit_message_names')
              ...
              : 'ibc.core.channel.v1'),
      createEmptyInstance: create)
    ..pc<$3.PacketState>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'commitments', $pb.PbFieldType.PM,
        subBuilder: $3.PacketState.create)
    ..aOM<$4.PageResponse>(
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          const $core.bool.fromEnvironment('protobuf.omit_message_names')
              ...
              : 'ibc.core.channel.v1'),
      createEmptyInstance: create)
    ..pc<$3.PacketState>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'acknowledgements', $pb.PbFieldType.PM,
        subBuilder: $3.PacketState.create)
    ..aOM<$4.PageResponse>(
        2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pagination',
        subBuilder: $4.PageResponse.create)
...
class QueryNextSequenceReceiveResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..a<$core.List<$core.int>>(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'proof',
        $pb.PbFieldType.OY)
    ..aOM<$2.Height>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'proofHeight', subBuilder: $2.Height.create)
    ..hasRequiredFields = false;
