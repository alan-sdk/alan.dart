...
class Channel extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..e<State>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state', $pb.PbFieldType.OE,
        defaultOrMaker: State.STATE_UNINITIALIZED_UNSPECIFIED,
        valueOf: State.valueOf,
        enumValues: State.values)
    ..e<Order>(
        2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'ordering', $pb.PbFieldType.OE,
  ...
  Channel copyWith(void Function(Channel) updates) =>
      super.copyWith((message) =>
          updates(message as Channel)); // ignore: deprecated_member_use
...
class IdentifiedChannel extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..e<State>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state', $pb.PbFieldType.OE,
        ...
        valueOf: State.valueOf,
        enumValues: State.values)
    ..e<Order>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'ordering', $pb.PbFieldType.OE,
        defaultOrMaker: Order.ORDER_NONE_UNSPECIFIED,
        valueOf: Order.valueOf,
        enumValues: Order.values)
    ..aOM<Counterparty>(
  ...
  IdentifiedChannel copyWith(void Function(IdentifiedChannel) updates) =>
      super.copyWith((message) => updates(
          message as IdentifiedChannel)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Counterparty extends $pb.GeneratedMessage {
  ...
  Counterparty copyWith(void Function(Counterparty) updates) =>
      super.copyWith((message) =>
          updates(message as Counterparty)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Packet extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOS(2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sourcePort')
    ...
    ..aOM<$2.Height>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'timeoutHeight', subBuilder: $2.Height.create)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  Packet copyWith(void Function(Packet) updates) => super.copyWith(
      (message) => updates(message as Packet)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class PacketState extends $pb.GeneratedMessage {
  ...
  PacketState copyWith(void Function(PacketState) updates) =>
      super.copyWith((message) =>
          updates(message as PacketState)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Acknowledgement extends $pb.GeneratedMessage {
  ...
  Acknowledgement copyWith(void Function(Acknowledgement) updates) =>
      super.copyWith((message) =>
          updates(message as Acknowledgement)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
