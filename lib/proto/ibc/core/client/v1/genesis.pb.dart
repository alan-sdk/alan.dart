...
class GenesisState extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<$3.IdentifiedClientState>(
        1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'clients', $pb.PbFieldType.PM,
        subBuilder: $3.IdentifiedClientState.create)
    ..pc<$3.ClientConsensusStates>(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'clientsConsensus',
        $pb.PbFieldType.PM,
        subBuilder: $3.ClientConsensusStates.create)
