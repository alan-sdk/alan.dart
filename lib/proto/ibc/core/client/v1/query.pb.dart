...
class QueryClientStateRequest extends $pb.GeneratedMessage {
  ...
  QueryClientStateRequest copyWith(
      ...
      super.copyWith((message) => updates(
          message as QueryClientStateRequest)); // ignore: deprecated_member_use
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          const $core.bool.fromEnvironment('protobuf.omit_message_names')
              ...
              : 'ibc.core.client.v1'),
      createEmptyInstance: create)
    ..aOM<$2.Any>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'clientState',
    ...
    ..a<$core.List<$core.int>>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'proof',
        $pb.PbFieldType.OY)
    ..aOM<$3.Height>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'proofHeight',
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          const $core.bool.fromEnvironment('protobuf.omit_message_names')
              ...
              : 'ibc.core.client.v1'),
      createEmptyInstance: create)
    ..pc<$3.IdentifiedClientState>(
        1,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'clientStates',
        $pb.PbFieldType.PM,
        subBuilder: $3.IdentifiedClientState.create)
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          const $core.bool.fromEnvironment('protobuf.omit_message_names')
              ...
              : 'ibc.core.client.v1'),
      createEmptyInstance: create)
    ..pc<$3.ConsensusStateWithHeight>(
        1,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'consensusStates',
        $pb.PbFieldType.PM,
        subBuilder: $3.ConsensusStateWithHeight.create)
    ..aOM<$4.PageResponse>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pagination',
        subBuilder: $4.PageResponse.create)
    ..hasRequiredFields = false;
