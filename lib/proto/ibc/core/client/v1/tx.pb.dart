...
class MsgCreateClient extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOS(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'clientId')
    ..aOM<$2.Any>(
        2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'clientState',
        subBuilder: $2.Any.create)
    ..aOM<$2.Any>(3,
        const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'consensusState',
        subBuilder: $2.Any.create)
  ...
  MsgCreateClient copyWith(void Function(MsgCreateClient) updates) =>
      super.copyWith((message) =>
          updates(message as MsgCreateClient)); // ignore: deprecated_member_use
...
class MsgCreateClientResponse extends $pb.GeneratedMessage {
  ...
  MsgCreateClientResponse copyWith(
      ...
      super.copyWith((message) => updates(
          message as MsgCreateClientResponse)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class MsgUpdateClient extends $pb.GeneratedMessage {
  ...
  MsgUpdateClient copyWith(void Function(MsgUpdateClient) updates) =>
      super.copyWith((message) =>
          updates(message as MsgUpdateClient)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class MsgUpdateClientResponse extends $pb.GeneratedMessage {
  ...
  MsgUpdateClientResponse copyWith(
      ...
      super.copyWith((message) => updates(
          message as MsgUpdateClientResponse)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class MsgUpgradeClient extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOS(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'clientId')
    ..aOM<$2.Any>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'clientState',
        subBuilder: $2.Any.create)
    ..aOM<$3.Height>(
        3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'upgradeHeight',
        subBuilder: $3.Height.create)
    ..a<$core.List<$core.int>>(
        4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'proofUpgrade', $pb.PbFieldType.OY)
  ...
  MsgUpgradeClient copyWith(void Function(MsgUpgradeClient) updates) =>
      super.copyWith((message) => updates(
          message as MsgUpgradeClient)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(3)
  $3.Height get upgradeHeight => $_getN(2);
  @$pb.TagNumber(3)
  set upgradeHeight($3.Height v) {
    setField(3, v);
  }

  @$pb.TagNumber(3)
  $core.bool hasUpgradeHeight() => $_has(2);
  @$pb.TagNumber(3)
  void clearUpgradeHeight() => clearField(3);
  @$pb.TagNumber(3)
  $3.Height ensureUpgradeHeight() => $_ensure(2);

  @$pb.TagNumber(4)
  $core.List<$core.int> get proofUpgrade => $_getN(3);
  @$pb.TagNumber(4)
  set proofUpgrade($core.List<$core.int> v) {
    $_setBytes(3, v);
  }

  @$pb.TagNumber(4)
  $core.bool hasProofUpgrade() => $_has(3);
  @$pb.TagNumber(4)
  void clearProofUpgrade() => clearField(4);
...
class MsgSubmitMisbehaviour extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$2.Any>(
        ...
        subBuilder: $2.Any.create)
    ..aOS(
        3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'signer')
    ..hasRequiredFields = false;
  ...
  MsgSubmitMisbehaviour copyWith(
      ...
      super.copyWith((message) => updates(
          message as MsgSubmitMisbehaviour)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
