...
class IdentifiedClientState extends $pb.GeneratedMessage {
  ...
  IdentifiedClientState copyWith(
      ...
      super.copyWith((message) => updates(
          message as IdentifiedClientState)); // ignore: deprecated_member_use
...
class ConsensusStateWithHeight extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      createEmptyInstance: create)
    ..aOM<Height>(
        1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'height',
...
class ClientConsensusStates extends $pb.GeneratedMessage {
  ...
  ClientConsensusStates copyWith(
      ...
      super.copyWith((message) => updates(
          message as ClientConsensusStates)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ClientUpdateProposal extends $pb.GeneratedMessage {
  ...
  ClientUpdateProposal copyWith(void Function(ClientUpdateProposal) updates) =>
      super.copyWith((message) => updates(
          message as ClientUpdateProposal)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Height extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i =
      $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Height',
          package: const $pb.PackageName(
              const $core.bool.fromEnvironment('protobuf.omit_message_names')
                  ? ''
                  : 'ibc.core.client.v1'),
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  Height copyWith(void Function(Height) updates) => super.copyWith(
      (message) => updates(message as Height)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  $fixnum.Int64 get versionHeight => $_getI64(1);
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(2)
  $core.bool hasVersionHeight() => $_has(1);
  @$pb.TagNumber(2)
  void clearVersionHeight() => clearField(2);
}
