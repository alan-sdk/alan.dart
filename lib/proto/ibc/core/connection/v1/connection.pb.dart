...
class ConnectionEnd extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOS(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'clientId')
    ..pc<Version>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'versions', $pb.PbFieldType.PM,
        subBuilder: Version.create)
    ..e<State>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state', $pb.PbFieldType.OE,
        defaultOrMaker: State.STATE_UNINITIALIZED_UNSPECIFIED,
        valueOf: State.valueOf,
        enumValues: State.values)
    ..aOM<Counterparty>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'counterparty',
  ...
  ConnectionEnd copyWith(void Function(ConnectionEnd) updates) =>
      super.copyWith((message) =>
          updates(message as ConnectionEnd)); // ignore: deprecated_member_use
...
class IdentifiedConnection extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOS(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'clientId')
    ..pc<Version>(
        3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'versions', $pb.PbFieldType.PM,
        subBuilder: Version.create)
    ..e<State>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state', $pb.PbFieldType.OE,
        defaultOrMaker: State.STATE_UNINITIALIZED_UNSPECIFIED,
        valueOf: State.valueOf,
        enumValues: State.values)
  ...
  IdentifiedConnection copyWith(void Function(IdentifiedConnection) updates) =>
      super.copyWith((message) => updates(
          message as IdentifiedConnection)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$2.MerklePrefix>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'prefix',
        subBuilder: $2.MerklePrefix.create)
    ..hasRequiredFields = false;
...
class ClientPaths extends $pb.GeneratedMessage {
  ...
  ClientPaths copyWith(void Function(ClientPaths) updates) =>
      super.copyWith((message) =>
          updates(message as ClientPaths)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ConnectionPaths extends $pb.GeneratedMessage {
  ...
  ConnectionPaths copyWith(void Function(ConnectionPaths) updates) =>
      super.copyWith((message) =>
          updates(message as ConnectionPaths)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
