...
class QueryConnectionRequest extends $pb.GeneratedMessage {
  ...
  QueryConnectionRequest copyWith(
      ...
      super.copyWith((message) => updates(
          message as QueryConnectionRequest)); // ignore: deprecated_member_use
...
class QueryConnectionResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      createEmptyInstance: create)
    ..aOM<$3.ConnectionEnd>(
        1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'connection',
        subBuilder: $3.ConnectionEnd.create)
    ..a<$core.List<$core.int>>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'proof',
        $pb.PbFieldType.OY)
    ..aOM<$4.Height>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'proofHeight',
  ...
  QueryConnectionResponse copyWith(
      ...
      super.copyWith((message) => updates(
          message as QueryConnectionResponse)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set connection($3.ConnectionEnd v) {
    setField(1, v);
  }
...
class QueryConnectionsRequest extends $pb.GeneratedMessage {
  ...
  QueryConnectionsRequest copyWith(
      ...
      super.copyWith((message) => updates(
          message as QueryConnectionsRequest)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          const $core.bool.fromEnvironment('protobuf.omit_message_names')
              ...
              : 'ibc.core.connection.v1'),
      createEmptyInstance: create)
    ..pc<$3.IdentifiedConnection>(
        1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'connections', $pb.PbFieldType.PM,
        subBuilder: $3.IdentifiedConnection.create)
    ..aOM<$5.PageResponse>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pagination',
        subBuilder: $5.PageResponse.create)
    ..aOM<$4.Height>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'height',
        subBuilder: $4.Height.create)
    ..hasRequiredFields = false;
...
class QueryConnectionClientStateResponse extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  set identifiedClientState($4.IdentifiedClientState v) {
    setField(1, v);
  }
...
class QueryConnectionConsensusStateRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOS(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'connectionId')
    ..a<$fixnum.Int64>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'versionNumber', $pb.PbFieldType.OU6,
        defaultOrMaker: $fixnum.Int64.ZERO)
    ..a<$fixnum.Int64>(
        3,
        const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'versionHeight',
        $pb.PbFieldType.OU6,
        defaultOrMaker: $fixnum.Int64.ZERO)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(3)
  $fixnum.Int64 get versionHeight => $_getI64(2);
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(3)
  $core.bool hasVersionHeight() => $_has(2);
  @$pb.TagNumber(3)
  void clearVersionHeight() => clearField(3);
}
...
class QueryConnectionConsensusStateResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$4.Height>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'proofHeight', subBuilder: $4.Height.create)
    ..hasRequiredFields = false;
