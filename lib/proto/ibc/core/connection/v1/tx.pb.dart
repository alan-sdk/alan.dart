...
import 'connection.pb.dart' as $1extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MsgConnectionOpenInit', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ibc.core.connection.v1'), createEmptyInstance: create)
    ...
    ..aOM<$3.Counterparty>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'counterparty', subBuilder: $3.Counterparty.create)
    ..aOM<$3.Version>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'version', subBuilder: $3.Version.create)
  ...
  @$pb.TagNumber(3)
  $3.Counterparty get counterparty => $_getN(2);
  @$pb.TagNumber(3)
  set counterparty($3.Counterparty v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasCounterparty() => $_has(2);
  @$pb.TagNumber(3)
  void clearCounterparty() => clearField(3);
  @$pb.TagNumber(3)
  $3.Counterparty ensureCounterparty() => $_ensure(2);
...
class MsgConnectionOpenTry extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MsgConnectionOpenTry', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ibc.core.connection.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'clientId')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'desiredConnectionId')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'counterpartyChosenConnectionId')
    ..aOM<$6.Any>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'clientState', subBuilder: $6.Any.create)
    ..aOM<$3.Counterparty>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'counterparty', subBuilder: $3.Counterparty.create)
    ..pc<$3.Version>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'counterpartyVersions', $pb.PbFieldType.PM, subBuilder: $3.Version.create)
    ..aOM<$4.Height>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'proofHeight', subBuilder: $4.Height.create)
    ...
    ..aOM<$4.Height>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'consensusHeight', subBuilder: $4.Height.create)
  ...
  @$pb.TagNumber(2)
  $core.String get desiredConnectionId => $_getSZ(1);
  @$pb.TagNumber(2)
  set desiredConnectionId($core.String v) { $_setString(1, v); }
  @$pb.TagNumber(2)
  $core.bool hasDesiredConnectionId() => $_has(1);
  @$pb.TagNumber(2)
  void clearDesiredConnectionId() => clearField(2);

  @$pb.TagNumber(3)
  $core.String get counterpartyChosenConnectionId => $_getSZ(2);
  @$pb.TagNumber(3)
  set counterpartyChosenConnectionId($core.String v) { $_setString(2, v); }
  @$pb.TagNumber(3)
  $core.bool hasCounterpartyChosenConnectionId() => $_has(2);
  @$pb.TagNumber(3)
  void clearCounterpartyChosenConnectionId() => clearField(3);
  ...
  @$pb.TagNumber(5)
  $3.Counterparty get counterparty => $_getN(4);
  @$pb.TagNumber(5)
  set counterparty($3.Counterparty v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasCounterparty() => $_has(4);
  @$pb.TagNumber(5)
  void clearCounterparty() => clearField(5);
  @$pb.TagNumber(5)
  $3.Counterparty ensureCounterparty() => $_ensure(4);
...
class MsgConnectionOpenAck extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MsgConnectionOpenAck', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ibc.core.connection.v1'), createEmptyInstance: create)
    ...
    ..aOM<$3.Version>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'version', subBuilder: $3.Version.create)
    ..aOM<$6.Any>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'clientState', subBuilder: $6.Any.create)
    ..aOM<$4.Height>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'proofHeight', subBuilder: $4.Height.create)
    ...
    ..aOM<$4.Height>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'consensusHeight', subBuilder: $4.Height.create)
...
class MsgConnectionOpenConfirm extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MsgConnectionOpenConfirm', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ibc.core.connection.v1'), createEmptyInstance: create)
    ...
    ..aOM<$4.Height>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'proofHeight', subBuilder: $4.Height.create)
