...
class MsgConnectionOpenInit extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOS(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'connectionId')
    ..aOM<$3.Counterparty>(
        3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'counterparty',
        subBuilder: $3.Counterparty.create)
    ..aOM<$3.Version>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'version',
        subBuilder: $3.Version.create)
  ...
  MsgConnectionOpenInit copyWith(
      ...
      super.copyWith((message) => updates(
          message as MsgConnectionOpenInit)); // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(3)
  set counterparty($3.Counterparty v) {
    setField(3, v);
  }
...
class MsgConnectionOpenTry extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$6.Any>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'clientState',
  ...
  MsgConnectionOpenTry copyWith(void Function(MsgConnectionOpenTry) updates) =>
      super.copyWith((message) => updates(
          message as MsgConnectionOpenTry)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  set desiredConnectionId($core.String v) {
    $_setString(1, v);
  }
  ...
  @$pb.TagNumber(3)
  set counterpartyChosenConnectionId($core.String v) {
    $_setString(2, v);
  }
  ...
  @$pb.TagNumber(11)
  set consensusHeight($4.Height v) {
    setField(11, v);
  }
...
class MsgConnectionOpenAck extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$3.Version>(
        3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'version',
        subBuilder: $3.Version.create)
    ..aOM<$6.Any>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'clientState',
        subBuilder: $6.Any.create)
  ...
  MsgConnectionOpenAck copyWith(void Function(MsgConnectionOpenAck) updates) =>
      super.copyWith((message) => updates(
          message as MsgConnectionOpenAck)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class MsgConnectionOpenConfirm extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..a<$core.List<$core.int>>(
        ...
        $pb.PbFieldType.OY)
    ..aOM<$4.Height>(3,
        const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'proofHeight',
        subBuilder: $4.Height.create)
