...
class ClientState extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ClientState',
    ...
    ..aOS(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'chainId')
    ..aOM<Fraction>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'trustLevel',
        subBuilder: Fraction.create)
    ..aOM<$0.Duration>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'trustingPeriod',
        subBuilder: $0.Duration.create)
    ..aOM<$0.Duration>(
        4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'unbondingPeriod',
        subBuilder: $0.Duration.create)
    ..aOM<$0.Duration>(
        5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'maxClockDrift',
        subBuilder: $0.Duration.create)
    ...
    ..aOS(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'upgradePath')
  ...
  @$pb.TagNumber(9)
  $core.String get upgradePath => $_getSZ(8);
  @$pb.TagNumber(9)
  set upgradePath($core.String v) {
    $_setString(8, v);
  }

  @$pb.TagNumber(9)
  $core.bool hasUpgradePath() => $_has(8);
  @$pb.TagNumber(9)
  void clearUpgradePath() => clearField(9);
...
class ConsensusState extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      createEmptyInstance: create)
    ..aOM<$3.Timestamp>(
        1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'timestamp',
        subBuilder: $3.Timestamp.create)
    ..aOM<$4.MerkleRoot>(
        2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'root',
        subBuilder: $4.MerkleRoot.create)
    ..a<$core.List<$core.int>>(
        3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'nextValidatorsHash', $pb.PbFieldType.OY)
    ..hasRequiredFields = false;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOS(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'clientId')
    ..aOM<Header>(
        2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'header1',
        protoName: 'header_1', subBuilder: Header.create)
    ..aOM<Header>(3,
        const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'header2',
...
class Header extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Header',
    ...
    ..aOM<$6.ValidatorSet>(
        2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'validatorSet',
        subBuilder: $6.ValidatorSet.create)
    ..aOM<$1.Height>(
        3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'trustedHeight',
        subBuilder: $1.Height.create)
    ..aOM<$6.ValidatorSet>(
        4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'trustedValidators',
        subBuilder: $6.ValidatorSet.create)
    ..hasRequiredFields = false;
...
class Fraction extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i =
      $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Fraction',
          package: const $pb.PackageName(
              const $core.bool.fromEnvironment('protobuf.omit_message_names')
                  ? ''
                  : 'ibc.lightclients.tendermint.v1'),
        ...
        ..a<$fixnum.Int64>(
            2,
            const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'denominator',
            $pb.PbFieldType.OU6,
            defaultOrMaker: $fixnum.Int64.ZERO)
        ..hasRequiredFields = false;
  ...
  Fraction copyWith(void Function(Fraction) updates) =>
      super.copyWith((message) =>
          updates(message as Fraction)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
