...
class ClientState extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..a<$fixnum.Int64>(
        1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sequence', $pb.PbFieldType.OU6,
        defaultOrMaker: $fixnum.Int64.ZERO)
    ..a<$fixnum.Int64>(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'frozenSequence',
        $pb.PbFieldType.OU6,
        defaultOrMaker: $fixnum.Int64.ZERO)
  ...
  ClientState copyWith(void Function(ClientState) updates) =>
      super.copyWith((message) =>
          updates(message as ClientState)); // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(2)
  set frozenSequence($fixnum.Int64 v) {
    $_setInt64(1, v);
  }
...
class ConsensusState extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i =
      $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ConsensusState',
          package: const $pb.PackageName(
              const $core.bool.fromEnvironment('protobuf.omit_message_names')
                  ? ''
                  : 'ibc.lightclients.solomachine.v1'),
          createEmptyInstance: create)
        ..aOM<$0.Any>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'publicKey',
  ...
  ConsensusState copyWith(void Function(ConsensusState) updates) =>
      super.copyWith((message) =>
          updates(message as ConsensusState)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Header extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  Header copyWith(void Function(Header) updates) => super.copyWith(
      (message) => updates(message as Header)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Misbehaviour extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i =
      $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Misbehaviour',
          package: const $pb.PackageName(
              const $core.bool.fromEnvironment('protobuf.omit_message_names')
                  ? ''
                  : 'ibc.lightclients.solomachine.v1'),
        ...
        ..aOS(
            ...
            const $core.bool.fromEnvironment('protobuf.omit_field_names')
                ...
                : 'clientId')
        ..a<$fixnum.Int64>(
            2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sequence', $pb.PbFieldType.OU6,
            defaultOrMaker: $fixnum.Int64.ZERO)
        ..aOM<SignatureAndData>(
            3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'signatureOne',
            subBuilder: SignatureAndData.create)
        ..aOM<SignatureAndData>(
            4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'signatureTwo',
            subBuilder: SignatureAndData.create)
        ..hasRequiredFields = false;
  ...
  Misbehaviour copyWith(void Function(Misbehaviour) updates) =>
      super.copyWith((message) =>
          updates(message as Misbehaviour)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SignatureAndData extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..a<$core.List<$core.int>>(
        ...
        $pb.PbFieldType.OY)
    ..e<DataType>(
        2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dataType', $pb.PbFieldType.OE,
  ...
  SignatureAndData copyWith(void Function(SignatureAndData) updates) =>
      super.copyWith((message) => updates(
          message as SignatureAndData)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class TimestampedSignatureData extends $pb.GeneratedMessage {
  ...
  TimestampedSignatureData copyWith(
      ...
      super.copyWith((message) => updates(message
          as TimestampedSignatureData)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SignBytes extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SignBytes',
      package: const $pb.PackageName(
          const $core.bool.fromEnvironment('protobuf.omit_message_names')
              ? ''
              : 'ibc.lightclients.solomachine.v1'),
      createEmptyInstance: create)
    ..a<$fixnum.Int64>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sequence', $pb.PbFieldType.OU6,
        defaultOrMaker: $fixnum.Int64.ZERO)
    ...
    ..aOS(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'diversifier')
    ..e<DataType>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dataType', $pb.PbFieldType.OE,
        defaultOrMaker: DataType.DATA_TYPE_UNINITIALIZED_UNSPECIFIED,
        valueOf: DataType.valueOf,
        enumValues: DataType.values)
  ...
  SignBytes copyWith(void Function(SignBytes) updates) =>
      super.copyWith((message) =>
          updates(message as SignBytes)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class HeaderData extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      createEmptyInstance: create)
    ..aOM<$0.Any>(1,
        const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'newPubKey',
        subBuilder: $0.Any.create)
    ..aOS(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
  ...
  HeaderData copyWith(void Function(HeaderData) updates) =>
      super.copyWith((message) =>
          updates(message as HeaderData)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ClientStateData extends $pb.GeneratedMessage {
  ...
  ClientStateData copyWith(void Function(ClientStateData) updates) =>
      super.copyWith((message) =>
          updates(message as ClientStateData)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ConsensusStateData extends $pb.GeneratedMessage {
  ...
  ConsensusStateData copyWith(void Function(ConsensusStateData) updates) =>
      super.copyWith((message) => updates(
          message as ConsensusStateData)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ConnectionStateData extends $pb.GeneratedMessage {
  ...
  ConnectionStateData copyWith(void Function(ConnectionStateData) updates) =>
      super.copyWith((message) => updates(
          message as ConnectionStateData)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ChannelStateData extends $pb.GeneratedMessage {
  ...
  ChannelStateData copyWith(void Function(ChannelStateData) updates) =>
      super.copyWith((message) => updates(
          message as ChannelStateData)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class PacketCommitmentData extends $pb.GeneratedMessage {
  ...
  PacketCommitmentData copyWith(void Function(PacketCommitmentData) updates) =>
      super.copyWith((message) => updates(
          message as PacketCommitmentData)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class PacketAcknowledgementData extends $pb.GeneratedMessage {
  ...
  PacketAcknowledgementData copyWith(
      ...
      super.copyWith((message) => updates(message
          as PacketAcknowledgementData)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class PacketReceiptAbsenceData extends $pb.GeneratedMessage {
  ...
  PacketReceiptAbsenceData copyWith(
      ...
      super.copyWith((message) => updates(message
          as PacketReceiptAbsenceData)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class NextSequenceRecvData extends $pb.GeneratedMessage {
  ...
  NextSequenceRecvData copyWith(void Function(NextSequenceRecvData) updates) =>
      super.copyWith((message) => updates(
          message as NextSequenceRecvData)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
