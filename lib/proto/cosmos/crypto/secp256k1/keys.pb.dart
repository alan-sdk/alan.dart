...
class PubKey extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      ...
      'Will be removed in next major version')
  PubKey copyWith(void Function(PubKey) updates) => super.copyWith(
      (message) => updates(message as PubKey)); // ignore: deprecated_member_use
...
class PrivKey extends $pb.GeneratedMessage {
  ...
  PrivKey copyWith(void Function(PrivKey) updates) =>
      super.copyWith((message) =>
          updates(message as PrivKey)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
