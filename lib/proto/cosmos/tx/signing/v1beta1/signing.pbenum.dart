...
class SignMode extends $pb.ProtobufEnum {
  static const SignMode SIGN_MODE_UNSPECIFIED = SignMode._(
      0,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'SIGN_MODE_UNSPECIFIED');
  static const SignMode SIGN_MODE_DIRECT = SignMode._(
      1,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'SIGN_MODE_DIRECT');
  static const SignMode SIGN_MODE_TEXTUAL = SignMode._(
      2,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'SIGN_MODE_TEXTUAL');
