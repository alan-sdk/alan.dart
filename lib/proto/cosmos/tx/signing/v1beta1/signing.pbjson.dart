...
const SignatureDescriptors$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.cosmos.tx.signing.v1beta1.SignatureDescriptor',
      '10': 'signatures'
    },
  ],
};
...
final $typed_data.Uint8List signatureDescriptorsDescriptor = $convert.base64Decode(
    'ChRTaWduYXR1cmVEZXNjcmlwdG9ycxJOCgpzaWduYXR1cmVzGAEgAygLMi4uY29zbW9zLnR4LnNpZ25pbmcudjFiZXRhMS5TaWduYXR1cmVEZXNjcmlwdG9yUgpzaWduYXR1cmVz');
...
const SignatureDescriptor$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.cosmos.tx.signing.v1beta1.SignatureDescriptor.Data',
      '10': 'data'
    },
...
const SignatureDescriptor_Data$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.cosmos.tx.signing.v1beta1.SignatureDescriptor.Data.Single',
      '9': 0,
      '10': 'single'
    },
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.cosmos.tx.signing.v1beta1.SignatureDescriptor.Data.Multi',
      '9': 0,
      '10': 'multi'
    },
  ],
...
final $typed_data.Uint8List signatureDescriptorDescriptor = $convert.base64Decode(
    '');
