...
class SignatureDescriptors extends $pb.GeneratedMessage {
  ...
  SignatureDescriptors copyWith(void Function(SignatureDescriptors) updates) =>
      super.copyWith((message) => updates(
          message as SignatureDescriptors)); // ignore: deprecated_member_use
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          const $core.bool.fromEnvironment('protobuf.omit_message_names')
              ...
              : 'cosmos.tx.signing.v1beta1'),
      createEmptyInstance: create)
    ..e<SignMode>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'mode',
        $pb.PbFieldType.OE,
    ...
    ..a<$core.List<$core.int>>(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'signature',
        $pb.PbFieldType.OY)
    ..hasRequiredFields = false;
...
class SignatureDescriptor extends $pb.GeneratedMessage {
  ...
  SignatureDescriptor copyWith(void Function(SignatureDescriptor) updates) =>
      super.copyWith((message) => updates(
          message as SignatureDescriptor)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
