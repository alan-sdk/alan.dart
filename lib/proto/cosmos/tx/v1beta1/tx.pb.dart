...
class Tx extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<TxBody>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'body',
        subBuilder: TxBody.create)
    ..aOM<AuthInfo>(
        2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'authInfo',
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      ...
      'Will be removed in next major version')
  Tx copyWith(void Function(Tx) updates) => super.copyWith(
      (message) => updates(message as Tx)); // ignore: deprecated_member_use
...
class TxRaw extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..a<$core.List<$core.int>>(
        ...
        $pb.PbFieldType.OY)
    ..p<$core.List<$core.int>>(
        3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'signatures', $pb.PbFieldType.PY)
    ..hasRequiredFields = false;

  TxRaw._() : super();
  factory TxRaw() => create();
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  TxRaw copyWith(void Function(TxRaw) updates) => super.copyWith(
      (message) => updates(message as TxRaw)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SignDoc extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..a<$core.List<$core.int>>(
        ...
        $pb.PbFieldType.OY)
    ..aOS(
        3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'chainId')
  ...
  SignDoc copyWith(void Function(SignDoc) updates) =>
      super.copyWith((message) =>
          updates(message as SignDoc)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class TxBody extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i =
      $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TxBody',
          package: const $pb.PackageName(
              const $core.bool.fromEnvironment('protobuf.omit_message_names')
                  ? ''
                  : 'cosmos.tx.v1beta1'),
          createEmptyInstance: create)
        ..pc<$2.Any>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'messages', $pb.PbFieldType.PM,
        ...
        ..a<$fixnum.Int64>(
            3,
            const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'timeoutHeight',
            $pb.PbFieldType.OU6,
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  TxBody copyWith(void Function(TxBody) updates) => super.copyWith(
      (message) => updates(message as TxBody)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class AuthInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<Fee>(
        2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'fee',
  ...
  AuthInfo copyWith(void Function(AuthInfo) updates) =>
      super.copyWith((message) =>
          updates(message as AuthInfo)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SignerInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          const $core.bool.fromEnvironment('protobuf.omit_message_names')
              ...
              : 'cosmos.tx.v1beta1'),
      createEmptyInstance: create)
    ..aOM<$2.Any>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'publicKey',
        subBuilder: $2.Any.create)
    ..aOM<ModeInfo>(
        2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'modeInfo',
        subBuilder: ModeInfo.create)
    ..a<$fixnum.Int64>(
        3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sequence', $pb.PbFieldType.OU6,
        defaultOrMaker: $fixnum.Int64.ZERO)
    ..hasRequiredFields = false;

  SignerInfo._() : super();
  factory SignerInfo() => create();
  ...
  SignerInfo copyWith(void Function(SignerInfo) updates) =>
      super.copyWith((message) =>
          updates(message as SignerInfo)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ModeInfo_Single extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..e<$5.SignMode>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'mode',
        $pb.PbFieldType.OE,
        defaultOrMaker: $5.SignMode.SIGN_MODE_UNSPECIFIED,
        valueOf: $5.SignMode.valueOf,
        enumValues: $5.SignMode.values)
    ..hasRequiredFields = false;

  ModeInfo_Single._() : super();
  factory ModeInfo_Single() => create();
  ...
  ModeInfo_Single copyWith(void Function(ModeInfo_Single) updates) =>
      super.copyWith((message) =>
          updates(message as ModeInfo_Single)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ModeInfo_Multi extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          const $core.bool.fromEnvironment('protobuf.omit_message_names')
              ...
              : 'cosmos.tx.v1beta1'),
      createEmptyInstance: create)
    ..aOM<$3.CompactBitArray>(
        1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'bitarray',
        subBuilder: $3.CompactBitArray.create)
    ..pc<ModeInfo>(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
  ...
  ModeInfo_Multi copyWith(void Function(ModeInfo_Multi) updates) =>
      super.copyWith((message) =>
          updates(message as ModeInfo_Multi)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set bitarray($3.CompactBitArray v) {
    setField(1, v);
  }
...
class ModeInfo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<ModeInfo_Multi>(
        2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'multi',
        subBuilder: ModeInfo_Multi.create)
    ..hasRequiredFields = false;

  ModeInfo._() : super();
  factory ModeInfo() => create();
  ...
  ModeInfo copyWith(void Function(ModeInfo) updates) =>
      super.copyWith((message) =>
          updates(message as ModeInfo)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Fee extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      createEmptyInstance: create)
    ..pc<$4.Coin>(
        1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'amount', $pb.PbFieldType.PM,
        subBuilder: $4.Coin.create)
    ..a<$fixnum.Int64>(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'gasLimit',
        $pb.PbFieldType.OU6,
        defaultOrMaker: $fixnum.Int64.ZERO)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  Fee copyWith(void Function(Fee) updates) => super.copyWith(
      (message) => updates(message as Fee)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
