...
class GetTxsEventRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$6.PageRequest>(
        ...
        subBuilder: $6.PageRequest.create)
    ..e<OrderBy>(
        3,
  ...
  GetTxsEventRequest copyWith(void Function(GetTxsEventRequest) updates) =>
      super.copyWith((message) => updates(
          message as GetTxsEventRequest)); // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(2)
  set pagination($6.PageRequest v) {
    setField(2, v);
  }
...
class GetTxsEventResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          const $core.bool.fromEnvironment('protobuf.omit_message_names')
              ...
              : 'cosmos.tx.v1beta1'),
      createEmptyInstance: create)
    ..pc<$7.Tx>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'txs', $pb.PbFieldType.PM,
        subBuilder: $7.Tx.create)
    ..pc<$8.TxResponse>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'txResponses', $pb.PbFieldType.PM,
        subBuilder: $8.TxResponse.create)
    ..aOM<$6.PageResponse>(
        3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pagination',
        subBuilder: $6.PageResponse.create)
    ..hasRequiredFields = false;
  ...
  GetTxsEventResponse copyWith(void Function(GetTxsEventResponse) updates) =>
      super.copyWith((message) => updates(
          message as GetTxsEventResponse)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(3)
  set pagination($6.PageResponse v) {
    setField(3, v);
  }
...
class BroadcastTxRequest extends $pb.GeneratedMessage {
  ...
  BroadcastTxRequest copyWith(void Function(BroadcastTxRequest) updates) =>
      super.copyWith((message) => updates(
          message as BroadcastTxRequest)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class BroadcastTxResponse extends $pb.GeneratedMessage {
  ...
  BroadcastTxResponse copyWith(void Function(BroadcastTxResponse) updates) =>
      super.copyWith((message) => updates(
          message as BroadcastTxResponse)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SimulateRequest extends $pb.GeneratedMessage {
  ...
  SimulateRequest copyWith(void Function(SimulateRequest) updates) =>
      super.copyWith((message) =>
          updates(message as SimulateRequest)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SimulateResponse extends $pb.GeneratedMessage {
  ...
  SimulateResponse copyWith(void Function(SimulateResponse) updates) =>
      super.copyWith((message) => updates(
          message as SimulateResponse)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class GetTxRequest extends $pb.GeneratedMessage {
  ...
  GetTxRequest copyWith(void Function(GetTxRequest) updates) =>
      super.copyWith((message) =>
          updates(message as GetTxRequest)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class GetTxResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      createEmptyInstance: create)
    ..aOM<$7.Tx>(
        1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'tx',
        subBuilder: $7.Tx.create)
    ..aOM<$8.TxResponse>(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
  ...
  GetTxResponse copyWith(void Function(GetTxResponse) updates) =>
      super.copyWith((message) =>
          updates(message as GetTxResponse)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
