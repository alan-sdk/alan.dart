...
class GenesisState extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$4.Params>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'params',
        subBuilder: $4.Params.create)
    ..pc<SigningInfo>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'signingInfos', $pb.PbFieldType.PM,
        subBuilder: SigningInfo.create)
    ..pc<ValidatorMissedBlocks>(
        3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'missedBlocks', $pb.PbFieldType.PM,
...
class SigningInfo extends $pb.GeneratedMessage {
  ...
  SigningInfo copyWith(void Function(SigningInfo) updates) =>
      super.copyWith((message) =>
          updates(message as SigningInfo)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ValidatorMissedBlocks extends $pb.GeneratedMessage {
  ...
  ValidatorMissedBlocks copyWith(
      ...
      super.copyWith((message) => updates(
          message as ValidatorMissedBlocks)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class MissedBlock extends $pb.GeneratedMessage {
  ...
  MissedBlock copyWith(void Function(MissedBlock) updates) =>
      super.copyWith((message) =>
          updates(message as MissedBlock)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
