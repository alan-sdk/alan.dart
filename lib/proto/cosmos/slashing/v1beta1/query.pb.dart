...
class QuerySigningInfoRequest extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  QuerySigningInfoRequest clone() =>
      QuerySigningInfoRequest()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  QuerySigningInfoRequest copyWith(
      ...
      super.copyWith((message) => updates(
          message as QuerySigningInfoRequest)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static QuerySigningInfoRequest create() => QuerySigningInfoRequest._();
  QuerySigningInfoRequest createEmptyInstance() => create();
  static $pb.PbList<QuerySigningInfoRequest> createRepeated() =>
      $pb.PbList<QuerySigningInfoRequest>();
  @$core.pragma('dart2js:noInline')
  static QuerySigningInfoRequest getDefault() => _defaultInstance ??=
...
class QuerySigningInfoResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          const $core.bool.fromEnvironment('protobuf.omit_message_names')
              ...
              : 'cosmos.slashing.v1beta1'),
      createEmptyInstance: create)
    ..aOM<$4.ValidatorSigningInfo>(
        1,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'valSigningInfo',
        subBuilder: $4.ValidatorSigningInfo.create)
    ..hasRequiredFields = false;
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  QuerySigningInfoResponse clone() =>
      QuerySigningInfoResponse()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  ...
  static $pb.PbList<QuerySigningInfoResponse> createRepeated() =>
      $pb.PbList<QuerySigningInfoResponse>();
  @$core.pragma('dart2js:noInline')
  static QuerySigningInfoResponse getDefault() => _defaultInstance ??=
  ...
  @$pb.TagNumber(1)
  set valSigningInfo($4.ValidatorSigningInfo v) {
    setField(1, v);
  }
...
class QuerySigningInfosRequest extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  QuerySigningInfosRequest clone() =>
      QuerySigningInfosRequest()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  ...
  static $pb.PbList<QuerySigningInfosRequest> createRepeated() =>
      $pb.PbList<QuerySigningInfosRequest>();
  @$core.pragma('dart2js:noInline')
  static QuerySigningInfosRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<QuerySigningInfosRequest>(create);
...
class QuerySigningInfosResponse extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  QuerySigningInfosResponse clone() =>
      QuerySigningInfosResponse()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  ...
  static $pb.PbList<QuerySigningInfosResponse> createRepeated() =>
      $pb.PbList<QuerySigningInfosResponse>();
  @$core.pragma('dart2js:noInline')
  static QuerySigningInfosResponse getDefault() => _defaultInstance ??=
