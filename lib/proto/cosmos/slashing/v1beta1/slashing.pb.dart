...
class ValidatorSigningInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aInt64(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'indexOffset')
    ..aOM<$2.Timestamp>(
        4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'jailedUntil',
  ...
  ValidatorSigningInfo copyWith(void Function(ValidatorSigningInfo) updates) =>
      super.copyWith((message) => updates(
          message as ValidatorSigningInfo)); // ignore: deprecated_member_use
...
class Params extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..a<$core.List<$core.int>>(
        ...
        $pb.PbFieldType.OY)
    ..aOM<$3.Duration>(
        3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'downtimeJailDuration',
        subBuilder: $3.Duration.create)
    ..a<$core.List<$core.int>>(
        4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'slashFractionDoubleSign', $pb.PbFieldType.OY)
  ...
  @$pb.TagNumber(3)
  set downtimeJailDuration($3.Duration v) {
    setField(3, v);
  }
