...
class Minter extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      ...
      'Will be removed in next major version')
  Minter copyWith(void Function(Minter) updates) => super.copyWith(
      (message) => updates(message as Minter)); // ignore: deprecated_member_use
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOS(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'inflationMax')
    ..aOS(4,
        const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'inflationMin')
