...
class Plan extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      ...
      'Will be removed in next major version')
  Plan copyWith(void Function(Plan) updates) => super.copyWith(
      (message) => updates(message as Plan)); // ignore: deprecated_member_use
...
class SoftwareUpgradeProposal extends $pb.GeneratedMessage {
  ...
  SoftwareUpgradeProposal copyWith(
      ...
      super.copyWith((message) => updates(
          message as SoftwareUpgradeProposal)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
