...
class Params extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOB(2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'defaultSendEnabled')
...
class SendEnabled extends $pb.GeneratedMessage {
  ...
  SendEnabled copyWith(void Function(SendEnabled) updates) =>
      super.copyWith((message) =>
          updates(message as SendEnabled)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Output extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  Output copyWith(void Function(Output) updates) => super.copyWith(
      (message) => updates(message as Output)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Supply extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  Supply copyWith(void Function(Supply) updates) => super.copyWith(
      (message) => updates(message as Supply)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class DenomUnit extends $pb.GeneratedMessage {
  ...
  DenomUnit copyWith(void Function(DenomUnit) updates) =>
      super.copyWith((message) =>
          updates(message as DenomUnit)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Metadata extends $pb.GeneratedMessage {
  ...
  Metadata copyWith(void Function(Metadata) updates) =>
      super.copyWith((message) =>
          updates(message as Metadata)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
