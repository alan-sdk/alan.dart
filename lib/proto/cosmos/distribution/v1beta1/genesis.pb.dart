...
class DelegatorWithdrawInfo extends $pb.GeneratedMessage {
  ...
  DelegatorWithdrawInfo copyWith(
      ...
      super.copyWith((message) => updates(
          message as DelegatorWithdrawInfo)); // ignore: deprecated_member_use
...
class ValidatorOutstandingRewardsRecord extends $pb.GeneratedMessage {
  ...
  ValidatorOutstandingRewardsRecord copyWith(
      ...
      super.copyWith((message) => updates(message
          as ValidatorOutstandingRewardsRecord)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ValidatorAccumulatedCommissionRecord extends $pb.GeneratedMessage {
  ...
  ValidatorAccumulatedCommissionRecord copyWith(
      ...
      super.copyWith((message) => updates(message
          as ValidatorAccumulatedCommissionRecord)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  set accumulated($3.ValidatorAccumulatedCommission v) {
    setField(2, v);
  }
...
class ValidatorHistoricalRewardsRecord extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOS(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'validatorAddress')
    ..a<$fixnum.Int64>(
        2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'period', $pb.PbFieldType.OU6,
        defaultOrMaker: $fixnum.Int64.ZERO)
    ..aOM<$3.ValidatorHistoricalRewards>(
        3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'rewards',
        subBuilder: $3.ValidatorHistoricalRewards.create)
    ..hasRequiredFields = false;
  ...
  ValidatorHistoricalRewardsRecord copyWith(
      ...
      super.copyWith((message) => updates(message
          as ValidatorHistoricalRewardsRecord)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(3)
  set rewards($3.ValidatorHistoricalRewards v) {
    setField(3, v);
  }
...
class ValidatorCurrentRewardsRecord extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOS(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'validatorAddress')
    ..aOM<$3.ValidatorCurrentRewards>(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'rewards',
        subBuilder: $3.ValidatorCurrentRewards.create)
    ..hasRequiredFields = false;
  ...
  ValidatorCurrentRewardsRecord copyWith(
      ...
      super.copyWith((message) => updates(message
          as ValidatorCurrentRewardsRecord)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  set rewards($3.ValidatorCurrentRewards v) {
    setField(2, v);
  }
...
class DelegatorStartingInfoRecord extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOS(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'validatorAddress')
    ..aOM<$3.DelegatorStartingInfo>(
        3,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'startingInfo',
        subBuilder: $3.DelegatorStartingInfo.create)
    ..hasRequiredFields = false;
  ...
  DelegatorStartingInfoRecord copyWith(
      ...
      super.copyWith((message) => updates(message
          as DelegatorStartingInfoRecord)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(3)
  set startingInfo($3.DelegatorStartingInfo v) {
    setField(3, v);
  }
...
class ValidatorSlashEventRecord extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOS(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'validatorAddress')
    ..a<$fixnum.Int64>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'height', $pb.PbFieldType.OU6,
        defaultOrMaker: $fixnum.Int64.ZERO)
    ..a<$fixnum.Int64>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'period', $pb.PbFieldType.OU6,
        defaultOrMaker: $fixnum.Int64.ZERO)
    ..aOM<$3.ValidatorSlashEvent>(
        4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'validatorSlashEvent',
  ...
  ValidatorSlashEventRecord copyWith(
      ...
      super.copyWith((message) => updates(message
          as ValidatorSlashEventRecord)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(4)
  set validatorSlashEvent($3.ValidatorSlashEvent v) {
    setField(4, v);
  }
...
class GenesisState extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GenesisState',
      package: const $pb.PackageName(
          const $core.bool.fromEnvironment('protobuf.omit_message_names')
              ...
              : 'cosmos.distribution.v1beta1'),
      createEmptyInstance: create)
    ..aOM<$3.Params>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'params',
        subBuilder: $3.Params.create)
    ..aOM<$3.FeePool>(
        2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'feePool',
        subBuilder: $3.FeePool.create)
  ...
  GenesisState copyWith(void Function(GenesisState) updates) =>
      super.copyWith((message) =>
          updates(message as GenesisState)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
