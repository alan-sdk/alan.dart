...
class GenesisState extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GenesisState',
    ...
    ..aOM<$7.Params>(
        1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'params',
    ...
    ..pc<LastValidatorPower>(
        3,
        const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lastValidatorPowers',
        $pb.PbFieldType.PM,
...
class LastValidatorPower extends $pb.GeneratedMessage {
  ...
  LastValidatorPower copyWith(void Function(LastValidatorPower) updates) =>
      super.copyWith((message) => updates(
          message as LastValidatorPower)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
