...
class Equivocation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aInt64(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'height')
    ..aOM<$2.Timestamp>(
        2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'time',
  ...
  Equivocation copyWith(void Function(Equivocation) updates) =>
      super.copyWith((message) =>
          updates(message as Equivocation)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static Equivocation create() => Equivocation._();
  Equivocation createEmptyInstance() => create();
  static $pb.PbList<Equivocation> createRepeated() =>
      $pb.PbList<Equivocation>();
  @$core.pragma('dart2js:noInline')
  static Equivocation getDefault() => _defaultInstance ??=
  ...
  @$pb.TagNumber(4)
  set consensusAddress($core.String v) {
    $_setString(3, v);
  }
