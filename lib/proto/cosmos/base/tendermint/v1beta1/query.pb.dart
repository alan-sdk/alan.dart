  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aInt64(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'blockHeight')
    ..pc<Validator>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'validators',
        $pb.PbFieldType.PM,
        subBuilder: Validator.create)
    ..aOM<$1.PageResponse>(
        3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pagination',
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOS(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'address')
    ..aOM<$2.Any>(
        2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pubKey',
...
class GetBlockByHeightRequest extends $pb.GeneratedMessage {
  ...
  GetBlockByHeightRequest copyWith(
      ...
      super.copyWith((message) => updates(
          message as GetBlockByHeightRequest)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class GetBlockByHeightResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$4.Block>(
        2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'block',
...
class GetLatestBlockRequest extends $pb.GeneratedMessage {
  ...
  GetLatestBlockRequest copyWith(
      ...
      super.copyWith((message) => updates(
          message as GetLatestBlockRequest)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class GetLatestBlockResponse extends $pb.GeneratedMessage {
  ...
  GetLatestBlockResponse copyWith(
      ...
      super.copyWith((message) => updates(
          message as GetLatestBlockResponse)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class GetSyncingRequest extends $pb.GeneratedMessage {
  ...
  GetSyncingRequest copyWith(void Function(GetSyncingRequest) updates) =>
      super.copyWith((message) => updates(
          message as GetSyncingRequest)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class GetSyncingResponse extends $pb.GeneratedMessage {
  ...
  GetSyncingResponse copyWith(void Function(GetSyncingResponse) updates) =>
      super.copyWith((message) => updates(
          message as GetSyncingResponse)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class GetNodeInfoRequest extends $pb.GeneratedMessage {
  ...
  GetNodeInfoRequest copyWith(void Function(GetNodeInfoRequest) updates) =>
      super.copyWith((message) => updates(
          message as GetNodeInfoRequest)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class GetNodeInfoResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$5.DefaultNodeInfo>(
        1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'defaultNodeInfo',
  ...
  GetNodeInfoResponse copyWith(void Function(GetNodeInfoResponse) updates) =>
      super.copyWith((message) => updates(
          message as GetNodeInfoResponse)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class VersionInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOS(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'version')
    ..aOS(4,
        const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'gitCommit')
  ...
  VersionInfo copyWith(void Function(VersionInfo) updates) =>
      super.copyWith((message) =>
          updates(message as VersionInfo)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Module extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  Module copyWith(void Function(Module) updates) => super.copyWith(
      (message) => updates(message as Module)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
