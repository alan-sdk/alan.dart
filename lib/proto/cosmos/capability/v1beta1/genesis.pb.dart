...
class GenesisOwners extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$0.CapabilityOwners>(
        2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'indexOwners',
  ...
  GenesisOwners copyWith(void Function(GenesisOwners) updates) =>
      super.copyWith((message) =>
          updates(message as GenesisOwners)); // ignore: deprecated_member_use
...
class GenesisState extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      createEmptyInstance: create)
    ..a<$fixnum.Int64>(
        1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'index', $pb.PbFieldType.OU6,
        defaultOrMaker: $fixnum.Int64.ZERO)
    ..pc<GenesisOwners>(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'owners',
        $pb.PbFieldType.PM,
